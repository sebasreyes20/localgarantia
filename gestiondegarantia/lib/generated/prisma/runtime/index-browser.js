...
h.comparedTo = h.cmp = function (e) {
  var n,
    ...
    l = this.s,
    f = e.s
  if (!o || !u) return !l || !f ? Number.NaN : l !== f ? l : o === u ? 0 : !o ^ (l < 0) ? 1 : -1
...
h.logarithm = h.log = function (e) {
  ...
  if (e == null) (e = new c(10)), (n = !0)
    ...
    if (((e = new c(e)), (i = e.d), e.s < 0 || !i || !i[0] || e.eq(1))) return new c(Number.NaN)
    n = e.eq(10)
  }
  if (((i = this.d), this.s < 0 || !i || !i[0] || this.eq(1)))
    return new c(i && !i[0] ? -1 / 0 : this.s != 1 ? Number.NaN : i ? 0 : 1 / 0)
  if (n)
    if (i.length > 1) s = !0
    else {
  ...
  if (
    ...
    do
      if (((u += 10), (o = B(this, u)), (t = n ? se(c, u + 10) : B(e, u)), (l = S(o, t, u, 1)), !s)) {
...
h.minus = h.sub = function (e) {
  ...
  if (((f = this.d), (d = e.d), (u = v.precision), (l = v.rounding), !f[0] || !d[0])) {
    if (d[0]) e.s = -e.s
    else if (f[0]) e = new v(this)
    else return new v(l === 3 ? -0 : 0)
    return w ? p(e, u, l) : e
  }
  if (((i = b(e.e / m)), (c = b(this.e / m)), (f = f.slice()), (s = c - i), s)) {
    for (
      a = s < 0,
  ...
  return (
    ...
    !this.d || !e.s || (e.d && !e.d[0])
      ...
      : !e.d || (this.d && !this.d[0])
        ...
        : ((w = !1),
          t.modulo == 9 ? ((n = S(this, e.abs(), 0, 3, 1)), (n.s *= e.s)) : (n = S(this, e, 0, t.modulo, 1)),
          (n = n.times(e)),
          (w = !0),
          this.minus(n))
  )
...
h.plus = h.add = function (e) {
  ...
  if (((f = this.d), (c = e.d), (u = d.precision), (l = d.rounding), !f[0] || !c[0]))
    return c[0] || (e = new d(this)), w ? p(e, u, l) : e
  if (((s = b(this.e / m)), (t = b(e.e / m)), (f = f.slice()), (r = s - t), r)) {
    for (
...
h.squareRoot = h.sqrt = function () {
  var e,
    ...
    f = this.s,
    c = this.constructor
  if (f !== 1 || !u || !u[0]) return new c(!f || (f < 0 && (!u || u[0])) ? Number.NaN : u ? this : 1 / 0)
  for (
    w = !1,
      f = Math.sqrt(+this),
      f == 0 || f == 1 / 0
    ...
    if (((s = t), (t = s.plus(S(this, s, i + 2, 1)).times(0.5)), O(s.d).slice(0, i) === (n = O(t.d)).slice(0, i)))
      if (((n = n.slice(i - 3, i + 1)), n == "9999" || (!r && n == "4999"))) {
        ...
        ;(!+n || (!+n.slice(1) && n.charAt(0) == "5")) && (p(t, l + 1, 1), (e = !t.times(t).eq(this)))
        break
      }
...
var S = (() => {
  ...
  return (t, r, s, o, u, l) => {
    ...
    if (!R || !R[0] || !k || !k[0])
      return new ee(
        !t.s || !r.s || (R ? k && R[0] == k[0] : !k) ? Number.NaN : (R && R[0] == 0) || !k ? ae * 0 : ae / 0,
      )
    for (
...
function B(e, n) {
  ...
  if (
    ...
    while ((t < 7 && t != 1) || (t == 1 && i.charAt(1) > 3)) (N = N.times(e)), (i = O(N.d)), (t = i.charAt(0)), g++
